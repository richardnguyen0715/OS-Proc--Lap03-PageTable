...
000000000000011a <grep>:
{
 ...
 140:	3b4a8a93          	addi	s5,s5,948 # 14f0 <buf>
 ...
 1ba:	33a50513          	addi	a0,a0,826 # 14f0 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	82658593          	addi	a1,a1,-2010 # a80 <malloc+0x10a>
 262:	4509                	li	a0,2
 ...
 294:	81050513          	addi	a0,a0,-2032 # aa0 <malloc+0x12a>
...
ugetpid(void)
{
 ...
 532:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffe70d>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 63a:	4e250513          	addi	a0,a0,1250 # b18 <digits>
 63e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 738:	00271793          	slli	a5,a4,0x2
 73c:	00000717          	auipc	a4,0x0
 740:	38470713          	addi	a4,a4,900 # ac0 <malloc+0x14a>
 ...
 7cc:	350b8b93          	addi	s7,s7,848 # b18 <digits>
 ...
 822:	29a90913          	addi	s2,s2,666 # ab8 <malloc+0x142>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9c6:	b1e90913          	addi	s2,s2,-1250 # 14e0 <freep>
  if(p == (char*)-1)
 9ca:	5afd                	li	s5,-1
 ...
 9da:	f1a78793          	addi	a5,a5,-230 # 18f0 <base>
 ...
 a44:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a46:	02071693          	slli	a3,a4,0x20
 a4a:	01c6d713          	srli	a4,a3,0x1c
