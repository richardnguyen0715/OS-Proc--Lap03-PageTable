...
main(int argc, char **argv)
{
  ...
  50:	7f458593          	addi	a1,a1,2036 # 840 <malloc+0x10c>
  54:	4509                	li	a0,2
  56:	00000097          	auipc	ra,0x0
  5a:	5f8080e7          	jalr	1528(ra) # 64e <fprintf>
    exit(1);
  5e:	4505                	li	a0,1
  60:	00000097          	auipc	ra,0x0
  64:	2a4080e7          	jalr	676(ra) # 304 <exit>
...
_main()
{
  ...
  7e:	28a080e7          	jalr	650(ra) # 304 <exit>
...
gets(char *buf, int max)
{
 ...
 170:	1b0080e7          	jalr	432(ra) # 31c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c0:	188080e7          	jalr	392(ra) # 344 <open>
  if(fd < 0)
 ...
 1d2:	18e080e7          	jalr	398(ra) # 35c <fstat>
 1d6:	892a                	mv	s2,a0
  close(fd);
 1d8:	8526                	mv	a0,s1
 1da:	00000097          	auipc	ra,0x0
 1de:	152080e7          	jalr	338(ra) # 32c <close>
  return r;
 1e2:	64a2                	ld	s1,8(sp)
}
 1e4:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2f0:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffebed>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	4c450513          	addi	a0,a0,1220 # 8b8 <digits>
 3fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fe:	36670713          	addi	a4,a4,870 # 860 <malloc+0x12c>
 ...
 58a:	332b8b93          	addi	s7,s7,818 # 8b8 <digits>
 ...
 5e0:	27c90913          	addi	s2,s2,636 # 858 <malloc+0x124>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c0:	d447b783          	ld	a5,-700(a5) # 1400 <freep>
 ...
 6e8:	00e6ea63          	bltu	a3,a4,6fc <free+0x4a>
{
 ...
 72a:	ccf73d23          	sd	a5,-806(a4) # 1400 <freep>
}
 72e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 754:	cb053503          	ld	a0,-848(a0) # 1400 <freep>
 ...
 784:	c8090913          	addi	s2,s2,-896 # 1400 <freep>
  if(p == (char*)-1)
 788:	5afd                	li	s5,-1
 ...
 798:	c7c78793          	addi	a5,a5,-900 # 1410 <base>
 79c:	00001717          	auipc	a4,0x1
 7a0:	c6f73223          	sd	a5,-924(a4) # 1400 <freep>
 7a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7de:	bb2080e7          	jalr	-1102(ra) # 38c <sbrk>
  if(p == (char*)-1)
 ...
 816:	bea73723          	sd	a0,-1042(a4) # 1400 <freep>
      return (void*)(p + 1);
