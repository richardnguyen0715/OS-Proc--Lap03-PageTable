...
main(void)
{
  ...
  12:	8c250513          	addi	a0,a0,-1854 # 8d0 <malloc+0x10c>
  ...
  3a:	8a290913          	addi	s2,s2,-1886 # 8d8 <malloc+0x114>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x164>
  ...
  8c:	84850513          	addi	a0,a0,-1976 # 8d0 <malloc+0x10c>
  90:	00000097          	auipc	ra,0x0
  94:	34c080e7          	jalr	844(ra) # 3dc <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	addi	a0,a0,-1994 # 8d0 <malloc+0x10c>
  a2:	00000097          	auipc	ra,0x0
  a6:	332080e7          	jalr	818(ra) # 3d4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	addi	a0,a0,-1980 # 8f0 <malloc+0x12c>
  ...
  ca:	33a58593          	addi	a1,a1,826 # 1400 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	83a50513          	addi	a0,a0,-1990 # 908 <malloc+0x144>
  d6:	00000097          	auipc	ra,0x0
  da:	2f6080e7          	jalr	758(ra) # 3cc <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	addi	a0,a0,-1998 # 910 <malloc+0x14c>
...
stat(const char *n, struct stat *st)
{
 ...
 250:	188080e7          	jalr	392(ra) # 3d4 <open>
  if(fd < 0)
...
ugetpid(void)
{
 ...
 380:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffebdd>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58e:	3c670713          	addi	a4,a4,966 # 950 <malloc+0x18c>
 ...
 61a:	392b8b93          	addi	s7,s7,914 # 9a8 <digits>
 ...
 670:	2dc90913          	addi	s2,s2,732 # 948 <malloc+0x184>
        while(*s != 0){
...
free(void *ap)
{
 ...
 750:	cc47b783          	ld	a5,-828(a5) # 1410 <freep>
 ...
 778:	00e6ea63          	bltu	a3,a4,78c <free+0x4a>
{
 ...
 7ba:	c4f73d23          	sd	a5,-934(a4) # 1410 <freep>
}
 7be:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7e4:	c3053503          	ld	a0,-976(a0) # 1410 <freep>
 ...
 814:	c0090913          	addi	s2,s2,-1024 # 1410 <freep>
  if(p == (char*)-1)
 818:	5afd                	li	s5,-1
 ...
 822:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
 824:	00001797          	auipc	a5,0x1
 828:	bfc78793          	addi	a5,a5,-1028 # 1420 <base>
 82c:	00001717          	auipc	a4,0x1
 830:	bef73223          	sd	a5,-1052(a4) # 1410 <freep>
 834:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86e:	bb2080e7          	jalr	-1102(ra) # 41c <sbrk>
  if(p == (char*)-1)
 ...
 8a6:	b6a73723          	sd	a0,-1170(a4) # 1410 <freep>
      return (void*)(p + 1);
