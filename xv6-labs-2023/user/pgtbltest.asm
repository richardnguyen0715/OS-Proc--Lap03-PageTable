...
err(char *why)
{
  ...
  28:	9ac50513          	addi	a0,a0,-1620 # 9d0 <malloc+0x100>
...
ugetpid_test()
{
  ...
  4c:	9b050513          	addi	a0,a0,-1616 # 9f8 <malloc+0x128>
  50:	00000097          	auipc	ra,0x0
  54:	7c8080e7          	jalr	1992(ra) # 818 <printf>
  testname = "ugetpid_test";
  58:	00001797          	auipc	a5,0x1
  5c:	9b878793          	addi	a5,a5,-1608 # a10 <malloc+0x140>
  ...
  94:	9a050513          	addi	a0,a0,-1632 # a30 <malloc+0x160>
  ...
  ce:	95650513          	addi	a0,a0,-1706 # a20 <malloc+0x150>
...
pgaccess_test()
{
  ...
  f2:	95a50513          	addi	a0,a0,-1702 # a48 <malloc+0x178>
  f6:	00000097          	auipc	ra,0x0
  fa:	722080e7          	jalr	1826(ra) # 818 <printf>
  testname = "pgaccess_test";
  fe:	00001797          	auipc	a5,0x1
 102:	96278793          	addi	a5,a5,-1694 # a60 <malloc+0x190>
 ...
 178:	0799                	addi	a5,a5,6 # 40000006 <base+0x3fffeb66>
 ...
 18c:	91850513          	addi	a0,a0,-1768 # aa0 <malloc+0x1d0>
 ...
 1a6:	8ce50513          	addi	a0,a0,-1842 # a70 <malloc+0x1a0>
 1aa:	00000097          	auipc	ra,0x0
 1ae:	e56080e7          	jalr	-426(ra) # 0 <err>
    err("pgaccess failed");
 1b2:	00001517          	auipc	a0,0x1
 1b6:	8be50513          	addi	a0,a0,-1858 # a70 <malloc+0x1a0>
 1ba:	00000097          	auipc	ra,0x0
 1be:	e46080e7          	jalr	-442(ra) # 0 <err>
    err("incorrect access bits set");
 1c2:	00001517          	auipc	a0,0x1
 1c6:	8be50513          	addi	a0,a0,-1858 # a80 <malloc+0x1b0>
...
00000000000001d2 <main>:
{
 ...
 1ee:	8ce50513          	addi	a0,a0,-1842 # ab8 <malloc+0x1e8>
...
ugetpid(void)
{
 ...
 48c:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffeb5d>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 594:	5b050513          	addi	a0,a0,1456 # b40 <digits>
 598:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 69a:	45270713          	addi	a4,a4,1106 # ae8 <malloc+0x218>
 ...
 726:	41eb8b93          	addi	s7,s7,1054 # b40 <digits>
 ...
 77c:	36890913          	addi	s2,s2,872 # ae0 <malloc+0x210>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 920:	b7490913          	addi	s2,s2,-1164 # 1490 <freep>
  if(p == (char*)-1)
 924:	5afd                	li	s5,-1
 ...
 934:	b7078793          	addi	a5,a5,-1168 # 14a0 <base>
