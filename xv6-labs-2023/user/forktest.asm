...
print(const char *s)
{
  ...
  20:	3b6080e7          	jalr	950(ra) # 3d2 <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	42e50513          	addi	a0,a0,1070 # 468 <pgaccess+0xe>
  ...
  54:	35a080e7          	jalr	858(ra) # 3aa <fork>
    if(pid < 0)
  ...
  68:	45450513          	addi	a0,a0,1108 # 4b8 <pgaccess+0x5e>
  6c:	00000097          	auipc	ra,0x0
  70:	f94080e7          	jalr	-108(ra) # 0 <print>
    exit(1);
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	33c080e7          	jalr	828(ra) # 3b2 <exit>
      exit(0);
  7e:	00000097          	auipc	ra,0x0
  82:	334080e7          	jalr	820(ra) # 3b2 <exit>
  }
  ...
  8a:	3f250513          	addi	a0,a0,1010 # 478 <pgaccess+0x1e>
  8e:	00000097          	auipc	ra,0x0
  92:	f72080e7          	jalr	-142(ra) # 0 <print>
      exit(1);
  96:	4505                	li	a0,1
  98:	00000097          	auipc	ra,0x0
  9c:	31a080e7          	jalr	794(ra) # 3b2 <exit>
    }
  }
  ...
  a4:	3f050513          	addi	a0,a0,1008 # 490 <pgaccess+0x36>
  a8:	00000097          	auipc	ra,0x0
  ac:	f58080e7          	jalr	-168(ra) # 0 <print>
    exit(1);
  b0:	4505                	li	a0,1
  b2:	00000097          	auipc	ra,0x0
  b6:	300080e7          	jalr	768(ra) # 3b2 <exit>
  for(; n > 0; n--){
  ba:	00905b63          	blez	s1,d0 <forktest+0xa2>
    if(wait(0) < 0){
  be:	4501                	li	a0,0
  c0:	00000097          	auipc	ra,0x0
  c4:	2fa080e7          	jalr	762(ra) # 3ba <wait>
  ...
  d6:	2e8080e7          	jalr	744(ra) # 3ba <wait>
  da:	57fd                	li	a5,-1
  ...
  e4:	3c850513          	addi	a0,a0,968 # 4a8 <pgaccess+0x4e>
...
main(void)
{
 ...
 112:	2a4080e7          	jalr	676(ra) # 3b2 <exit>
...
_main()
{
 ...
 12c:	28a080e7          	jalr	650(ra) # 3b2 <exit>
...
gets(char *buf, int max)
{
 ...
 21e:	1b0080e7          	jalr	432(ra) # 3ca <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 26e:	188080e7          	jalr	392(ra) # 3f2 <open>
  if(fd < 0)
 ...
 280:	18e080e7          	jalr	398(ra) # 40a <fstat>
 284:	892a                	mv	s2,a0
  close(fd);
 286:	8526                	mv	a0,s1
 288:	00000097          	auipc	ra,0x0
 28c:	152080e7          	jalr	338(ra) # 3da <close>
  return r;
 290:	64a2                	ld	s1,8(sp)
}
 292:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 398:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 39a:	040007b7          	lui	a5,0x4000
 39e:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff07d>
 3a0:	07b2                	slli	a5,a5,0xc
}
 3a2:	4388                	lw	a0,0(a5)
 3a4:	6422                	ld	s0,8(sp)
