...
main(int argc, char *argv[])
{
  ...
  1a:	8fa78793          	addi	a5,a5,-1798 # 910 <malloc+0x138>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8b450513          	addi	a0,a0,-1868 # 8e0 <malloc+0x108>
  ...
  6c:	89050513          	addi	a0,a0,-1904 # 8f8 <malloc+0x120>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	85250513          	addi	a0,a0,-1966 # 908 <malloc+0x130>
...
stat(const char *n, struct stat *st)
{
 ...
 264:	188080e7          	jalr	392(ra) # 3e8 <open>
  if(fd < 0)
...
ugetpid(void)
{
 ...
 394:	17f5                	addi	a5,a5,-3 # 3fffffd <base+0x3ffebed>
...
free(void *ap)
{
 ...
 764:	ca07b783          	ld	a5,-864(a5) # 1400 <freep>
 ...
 78c:	00e6ea63          	bltu	a3,a4,7a0 <free+0x4a>
{
 ...
 7ce:	c2f73b23          	sd	a5,-970(a4) # 1400 <freep>
}
 7d2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f8:	c0c53503          	ld	a0,-1012(a0) # 1400 <freep>
 ...
 828:	bdc90913          	addi	s2,s2,-1060 # 1400 <freep>
  if(p == (char*)-1)
 82c:	5afd                	li	s5,-1
 ...
 83c:	bd878793          	addi	a5,a5,-1064 # 1410 <base>
 840:	00001717          	auipc	a4,0x1
 844:	bcf73023          	sd	a5,-1088(a4) # 1400 <freep>
 848:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ba:	b4a73523          	sd	a0,-1206(a4) # 1400 <freep>
      return (void*)(p + 1);
